...
class JsonSchemaTestSuiteTest extends TestCase
{
    ...
    private function shouldNotYieldTest(string $name): bool
    {
        $skip = [
            ...
            '[draft7/optional/format/iri-reference.json]: validation of IRI References: an embedded IPv4 with a leading zero is invalid is expected to be invalid',
            '[draft7/optional/format/iri-reference.json]: validation of IRI References: a trailing newline after a valid IRI Reference is invalid is expected to be invalid',
            '[draft2019-09/optional/format/iri-reference.json]: validation of IRI References: an invalid IRI Reference is expected to be invalid',
            '[draft2019-09/optional/format/iri-reference.json]: validation of IRI References: an invalid IRI fragment is expected to be invalid',
            '[draft2019-09/optional/format/iri-reference.json]: validation of IRI References: an embedded IPv4 with a leading zero is invalid is expected to be invalid',
            '[draft2019-09/optional/format/iri-reference.json]: validation of IRI References: a trailing newline after a valid IRI Reference is invalid is expected to be invalid',
            ...
            '[draft7/optional/format/iri.json]: validation of IRIs: invalid percent-encoding with non-hex digits is expected to be invalid',
            '[draft7/optional/format/iri.json]: validation of IRIs: incomplete percent-encoding triplet is expected to be invalid',
            '[draft7/optional/format/iri.json]: validation of IRIs: lone percent sign is invalid is expected to be invalid',
            '[draft7/optional/format/iri.json]: validation of IRIs: an IPv6 address without enclosing brackets is invalid is expected to be invalid',
            '[draft7/optional/format/iri.json]: validation of IRIs: an IPv6 host whose embedded IPv4 has a leading zero is invalid is expected to be invalid',
            '[draft7/optional/format/iri.json]: validation of IRIs: a trailing newline after a valid IRI is invalid is expected to be invalid',
            '[draft2019-09/optional/format/iri.json]: validation of IRIs: invalid percent-encoding with non-hex digits is expected to be invalid',
            '[draft2019-09/optional/format/iri.json]: validation of IRIs: incomplete percent-encoding triplet is expected to be invalid',
            '[draft2019-09/optional/format/iri.json]: validation of IRIs: lone percent sign is invalid is expected to be invalid',
            '[draft2019-09/optional/format/iri.json]: validation of IRIs: an IPv6 address without enclosing brackets is invalid is expected to be invalid',
            '[draft2019-09/optional/format/iri.json]: validation of IRIs: an invalid relative IRI Reference is expected to be invalid',
            '[draft2019-09/optional/format/iri.json]: validation of IRIs: an invalid IRI is expected to be invalid',
            '[draft2019-09/optional/format/iri.json]: validation of IRIs: an invalid IRI though valid IRI reference is expected to be invalid',
            '[draft2019-09/optional/format/iri.json]: validation of IRIs: an IPv6 host whose embedded IPv4 has a leading zero is invalid is expected to be invalid',
            '[draft2019-09/optional/format/iri.json]: validation of IRIs: a trailing newline after a valid IRI is invalid is expected to be invalid',
            ...
            // Optional format uri-template: Not yet implemented
            '[draft6/optional/format/uri-template.json]: format: uri-template: a zero prefix max-length is invalid is expected to be invalid',
            '[draft6/optional/format/uri-template.json]: format: uri-template: a five-digit prefix max-length is invalid is expected to be invalid',
            '[draft6/optional/format/uri-template.json]: format: uri-template: a literal with a lone percent sign is invalid is expected to be invalid',
            '[draft6/optional/format/uri-template.json]: format: uri-template: a literal with an incomplete percent-encoded triplet is invalid is expected to be invalid',
            '[draft6/optional/format/uri-template.json]: format: uri-template: a literal with non-hex percent encoding is invalid is expected to be invalid',
            '[draft6/optional/format/uri-template.json]: format: uri-template: fragment expansion operator is expected to be valid',
            '[draft6/optional/format/uri-template.json]: format: uri-template: path style parameter expansion operator is expected to be valid',
            '[draft6/optional/format/uri-template.json]: format: uri-template: form style query expansion operator is expected to be valid',
            '[draft6/optional/format/uri-template.json]: format: uri-template: form style query continuation operator is expected to be valid',
            '[draft6/optional/format/uri-template.json]: format: uri-template: a variable list with more than one varspec is valid is expected to be valid',
            '[draft6/optional/format/uri-template.json]: format: uri-template: a double dot in a variable name is invalid is expected to be invalid',
            '[draft6/optional/format/uri-template.json]: format: uri-template: a variable name with a lone percent sign is invalid is expected to be invalid',
            '[draft6/optional/format/uri-template.json]: format: uri-template: a variable name with an incomplete percent-encoded triplet is invalid is expected to be invalid',
            '[draft6/optional/format/uri-template.json]: format: uri-template: a variable name with non-hex percent encoding is invalid is expected to be invalid',
            '[draft6/optional/format/uri-template.json]: format: uri-template: a leading zero in the prefix max-length is invalid is expected to be invalid',
            '[draft6/optional/format/uri-template.json]: format: uri-template: a space in a literal is invalid is expected to be invalid',
            '[draft6/optional/format/uri-template.json]: format: uri-template: a delete character in a literal is invalid is expected to be invalid',
            '[draft7/optional/format/uri-template.json]: format: uri-template: a zero prefix max-length is invalid is expected to be invalid',
            '[draft7/optional/format/uri-template.json]: format: uri-template: a five-digit prefix max-length is invalid is expected to be invalid',
            '[draft7/optional/format/uri-template.json]: format: uri-template: a literal with a lone percent sign is invalid is expected to be invalid',
            '[draft7/optional/format/uri-template.json]: format: uri-template: a literal with an incomplete percent-encoded triplet is invalid is expected to be invalid',
            '[draft7/optional/format/uri-template.json]: format: uri-template: a literal with non-hex percent encoding is invalid is expected to be invalid',
            '[draft7/optional/format/uri-template.json]: format: uri-template: fragment expansion operator is expected to be valid',
            '[draft7/optional/format/uri-template.json]: format: uri-template: path style parameter expansion operator is expected to be valid',
            '[draft7/optional/format/uri-template.json]: format: uri-template: form style query expansion operator is expected to be valid',
            '[draft7/optional/format/uri-template.json]: format: uri-template: form style query continuation operator is expected to be valid',
            '[draft7/optional/format/uri-template.json]: format: uri-template: a variable list with more than one varspec is valid is expected to be valid',
            '[draft7/optional/format/uri-template.json]: format: uri-template: a double dot in a variable name is invalid is expected to be invalid',
            '[draft7/optional/format/uri-template.json]: format: uri-template: a variable name with a lone percent sign is invalid is expected to be invalid',
            '[draft7/optional/format/uri-template.json]: format: uri-template: a variable name with an incomplete percent-encoded triplet is invalid is expected to be invalid',
            '[draft7/optional/format/uri-template.json]: format: uri-template: a variable name with non-hex percent encoding is invalid is expected to be invalid',
            '[draft7/optional/format/uri-template.json]: format: uri-template: a leading zero in the prefix max-length is invalid is expected to be invalid',
            '[draft7/optional/format/uri-template.json]: format: uri-template: a space in a literal is invalid is expected to be invalid',
            '[draft7/optional/format/uri-template.json]: format: uri-template: a delete character in a literal is invalid is expected to be invalid',
            '[draft2019-09/optional/format/uri-template.json]: format: uri-template: a zero prefix max-length is invalid is expected to be invalid',
            '[draft2019-09/optional/format/uri-template.json]: format: uri-template: a five-digit prefix max-length is invalid is expected to be invalid',
            '[draft2019-09/optional/format/uri-template.json]: format: uri-template: a literal with a lone percent sign is invalid is expected to be invalid',
            '[draft2019-09/optional/format/uri-template.json]: format: uri-template: a literal with an incomplete percent-encoded triplet is invalid is expected to be invalid',
            '[draft2019-09/optional/format/uri-template.json]: format: uri-template: a literal with non-hex percent encoding is invalid is expected to be invalid',
            '[draft2019-09/optional/format/uri-template.json]: format: uri-template: fragment expansion operator is expected to be valid',
            '[draft2019-09/optional/format/uri-template.json]: format: uri-template: path style parameter expansion operator is expected to be valid',
            '[draft2019-09/optional/format/uri-template.json]: format: uri-template: form style query expansion operator is expected to be valid',
            '[draft2019-09/optional/format/uri-template.json]: format: uri-template: form style query continuation operator is expected to be valid',
            '[draft2019-09/optional/format/uri-template.json]: format: uri-template: a variable list with more than one varspec is valid is expected to be valid',
            '[draft2019-09/optional/format/uri-template.json]: format: uri-template: a double dot in a variable name is invalid is expected to be invalid',
            '[draft2019-09/optional/format/uri-template.json]: format: uri-template: a variable name with a lone percent sign is invalid is expected to be invalid',
            '[draft2019-09/optional/format/uri-template.json]: format: uri-template: a variable name with an incomplete percent-encoded triplet is invalid is expected to be invalid',
            '[draft2019-09/optional/format/uri-template.json]: format: uri-template: a variable name with non-hex percent encoding is invalid is expected to be invalid',
            '[draft2019-09/optional/format/uri-template.json]: format: uri-template: a leading zero in the prefix max-length is invalid is expected to be invalid',
